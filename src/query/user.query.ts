...
// cette fonction cache permet de cacher la request et dans le cas la fonction cache est appeller plusieur fois dans la memes render , elle va appeller un seule fois
